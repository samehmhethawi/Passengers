...
namespace ProcedBase.Site.Helper
{
    public class ToWord
    {
        ...
        /// integer part
        /// </summary>
        public long _intergerValue;

        /// <summary>
        /// Decimal Part
        /// </summary>
        public int _decimalValue;
        ...
        /// <param name="arabicPrefixText">Arabic text to be placed before the generated text</param>
        /// <param name="arabicSuffixText">Arabic text to be placed after the generated text</param>
        public void InitializeClass(Decimal number, CurrencyInfo currency, String englishPrefixText, String englishSuffixText, String arabicPrefixText, String arabicSuffixText)
        {
            Number = number;
            Currency = currency;
        ...
        /// <returns></returns>
        public string GetDecimalValue(string decimalPart)
        {
        ...
        /// <returns></returns>
        public string ProcessGroup(int groupNumber)
        {
        ...
        /// <returns></returns>
        public string GetDigitFeminineStatus(int digit, int groupLevel)
        {
            if (groupLevel == -1)
        ...
        /// <param name="groupNumber">The group number to process</param>
        /// <returns></returns>
        public string ProcessArabicGroup(int groupNumber, int groupLevel, Decimal remainingNumber)
        {
            int tens = groupNumber % 100;
        ...
        /// </summary>
        /// <returns></returns>
        public string ConvertToArabic(Decimal tempNumber)
        {
