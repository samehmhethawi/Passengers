 ...
 * @license MIT Indexes, http://www.opensource.org/licenses/MIT
 */
...
;(function ($, window) {
  ...
  (function (p) {
      ...
      p.setElementWidths = function () {
        ...
        //if (parseInt($('.scrtabs-tabs-movable-container').css("left"), 10) < 0) {
        //    $('.scrtabs-tabs-movable-container').css({ "bottom": "-13px" });
        //} else {
        //    $('.scrtabs-tabs-movable-container').css({ "bottom": "0" });
        //}
      };
